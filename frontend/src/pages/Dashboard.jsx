...
const data = [
    ...
    { name: 'Tue', sales: 3000, revenue: 2100 },
    { name: 'Wed', sales: 5000, revenue: 4500 },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 flex items-center justify-between shadow-sm transition-transform hover:scale-[1.02]">
                    <div>
                        ...
                        <h4 className="text-2xl font-black mt-2 text-slate-900">12</h4>
                    </div>
                        ...
                        <div className="h-[280px] md:h-[350px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={data}>
                                    ...
                                    />
                                    <Area type="monotone" dataKey="sales" stroke="#CE2626" strokeWidth={3} fillOpacity={1} fill="url(#colorSales)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </div>
                ...
                <div className="xl:col-span-1 space-y-6">
                    <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-100 shadow-sm h-full">
                        ...
                        <div className="space-y-8 relative">
                            ...
                            {[
                                { action: "Material Stock Update", time: "10:30 AM", type: "Inventory", color: "bg-amber-500" },
                                { action: "New Employee Onboarded", time: "09:45 AM", type: "HR", color: "bg-indigo-500" },
                                { action: "Purchase Order Approved", time: "Yesterday", type: "ERP", color: "bg-emerald-500" },
                                { action: "Client Meeting Logged", time: "Yesterday", type: "CRM", color: "bg-rose-500" }
                            ].map((log, i) => (
                                <div key={i} className="relative pl-9 group">
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest">{log.type}</p>
                                        <span className="w-1 h-1 bg-slate-200 rounded-full"></span>
                                        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest">{log.time}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
