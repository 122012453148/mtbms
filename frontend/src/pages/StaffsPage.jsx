                ...
                <div className="relative z-10 flex w-full lg:w-auto">
                    <div className="relative w-full lg:w-80">
                        ...
                        <input
                            ...
                            className="bg-white/5 border border-white/10 text-white rounded-2xl py-4 pl-12 pr-6 text-xs font-black uppercase tracking-widest outline-none focus:ring-4 focus:ring-[#CE2626]/20 transition-all w-full"
                        />
                    </div>
                </div>
            </div>
