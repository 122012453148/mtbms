                ...
                <div className="relative" ref={profileRef}>
                    ...
                    >
                        <div className="relative group cursor-pointer z-30">
                            <div className="w-11 h-11 rounded-full border-2 border-white shadow-md overflow-hidden bg-slate-50 relative isolate">
                                <img 
                            ...
                            <div className="absolute bottom-0 right-0 w-3.5 h-3.5 bg-emerald-500 border-2 border-white rounded-full shadow-sm z-40"></div>
                        </div>
